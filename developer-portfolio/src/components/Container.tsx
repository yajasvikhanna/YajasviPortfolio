...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Yajasvi Khanna",
    description: `Full-stack website developer and Frontend enthusiast.`,
  ...
  return (
    <>
<Head>
  <title>Yajasvi Khanna Portfolio</title>  
  <meta name="description" content="I am a passionate and experienced full-stack developer with expertise in React.js, Node.js, Tailwind CSS, and MongoDB, with a strong foundation in JavaScript, Python, and C++. Since 2021, I have been building efficient, scalable, and user-friendly web applications. I specialize in creating modern, responsive user interfaces, and I am always eager to learn and implement the latest technologies. My experience spans from startups to mid-sized companies, where I have contributed to the full product development cycle, from ideation and design to the final delivery."/>

  <meta name="robots" content="follow, index" />
  
  <meta property="og:url" content={`https://www.yourwebsite.com${router.asPath}`} />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Your Website or Portfolio" />  
  <meta property="og:title" content="Your Name - Portfolio" /> 
  <meta property="og:description" content="I am a passionate and experienced full-stack developer with expertise in React.js, Node.js, Tailwind CSS, and MongoDB, with a strong foundation in JavaScript, Python, and C++. Since 2021, I have been building efficient, scalable, and user-friendly web applications. I specialize in creating modern, responsive user interfaces, and I am always eager to learn and implement the latest technologies. My experience spans from startups to mid-sized companies, where I have contributed to the full product development cycle, from ideation and design to the final delivery." /> 
  <meta property="og:image" content="https://www.yourwebsite.com/path/to/your/image.jpg" />
  <link rel="manifest" href="/manifest.json" />
  <link rel="icon" href="/Yajasvi_Fevicon.png" type="image/png"/>
  <link rel="canonical" href={`https://www.yourwebsite.com${router.asPath}`} />
</Head>
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Yajasvi Khanna</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} yajasvikhanna. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
